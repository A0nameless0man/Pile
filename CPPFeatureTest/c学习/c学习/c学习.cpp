...
#define END(x) \
    ...
    std::cout << "\tEnd:" << (#x) << std::endl << std::endl;
...
#define TIMING(x)                                                             \
    {                                                                         \
        ...
        (x);                                                                  \
        clock_t end = clock();                                                \
        std::cout << "It takes " << (((double) end - start) / CLOCKS_PER_SEC) \
                  << " seconds to exec " << #x << std::endl;                  \
    }
template <typename T>
...
namespace Question6
{
    ...
    public:
        ...
        {
            return os << dog.age << " " << dog.weight;
        }
        friend std::istream &operator>>(std::istream &is, Dog &dog)
        {
            return is >> dog.age >> dog.weight;
        }
...
int _main(void)
{
    START(std);
    {
        /*START(Section10);
        {
                ...
                START(Question8);
                {
                        cout <<"Result is : "<< count(std::stringstream("a aa b bb aa b")) <<
        std::endl;
                        //count(std::cin);
                }
                END(Question8);
        ...
        START(Section11);
        {
            std::filesystem::path testFile[] = { "test1.txt",
                                                 "test2.txt",
                                                 "sample.txt",
                                                 "sampleOut.txt",
                                                 "sampleOut2.txt" };
            ...
            START(Question4);
            {
                (std::fstream(testFile[0], std::ios_base::app | std::ios_base::out) << "Added!")
                  .close();
            }
            END(Question4);
            START(Question5);
