...
接下来的T行，每行包含一个数字序列，代表一只竹鼠的行为。第一个数字n表示竹鼠吃和睡的总时间（1 <= n <=
100）。数字序列由1和2组成。1代表竹鼠吃了一段时间的东西，2代表竹鼠睡了一段时间的觉。每个数字表示的吃或睡的时间长度相等。
输出描述
...
由于竹鼠最多一次连续吃东西的时间为3("1 1 1")，最多一次连续睡觉的时间为2("2
2")，所以它会被做成宽油竹鼠。
*/
int main(void)
{
