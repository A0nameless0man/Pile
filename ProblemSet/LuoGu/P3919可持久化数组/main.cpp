...
template <class T1, class T2>
inline Node<T1, T2>::Node(T1 key, T2 val):
    myKey(key),
    myVal(val),
    leftChild(NULL),
    rightChild(NULL),
...
//
// template<class T1, class T2>
// inline Node<T1, T2>::Node(const Node& copy) : myKey(copy.myKey), myVal(copy.myVal),
// leftChild(copy.leftChild), rightChild(copy.rightChild), ownLeft(false), ownRight(false) {}
