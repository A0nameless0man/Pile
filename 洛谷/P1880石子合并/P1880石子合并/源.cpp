...
int main(void)
{
    ...
    while(scanf("%d", &n) != EOF)
    {
        ...
        //		{
        //			Max = ForMax[ForMaxRoot].Stone +
        //ForMax[ForMax[ForMaxRoot].Child].Stone; 			MaxAt = ForMaxRoot;
        //		}
        ...
        //		{
        //			Min = ForMin[ForMinRoot].Stone +
        //ForMin[ForMin[ForMinRoot].Child].Stone; 			MinAt = ForMinRoot;
        //		}
